        ...
        <div>
          <div class="row">
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/tac.png"
                                                                  alt="Colorlib Template">
                  <%--                        <span class="status">30%</span>--%>
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp">Tắc</a></h3>
                  <div class="d-flex">
                    <div class="pricing">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/mit.png"
                                                                  alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp"></a>Mít</h3>
                  <div class="d-flex">
                    <div class="pricing">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/chanhvang.png"
                                                                  alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp"></a>Chanh vàng</h3>
                  <div class="d-flex">
                    <div class="pricing">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/chanhxanh.png"
                                                                  alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp">Chanh xanh</a></h3>
                  <div class="d-flex">
                    <div class="pricing">
                      <p class="price"><span>20.000 VND</span></p>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/man.png"
                                                                  alt="Colorlib Template">
                  <%--                        <span class="status">50%</span>--%>
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp">Mận</a></h3>
                  <div class="d-flex">
                    <div class="pricing">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/dao.png"
                                                                  alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp">Đào</a></h3>
                  <div class="d-flex">
                    <div class="pricing">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
              <div class="product">
                <a href="productdetail.jsp" class="img-prod"><img class="img-fluid"
                                                                  src="images/qua/chomchom.png"
                                                                  alt="Colorlib Template">
                  <div class="overlay"></div>
                </a>
                <div class="text py-3 pb-4 px-3 text-center">
                  <h3><a href="productdetail.jsp">Chôm chôm</a></h3>
                  <div class="d-flex">
                    <div class="pricing">
